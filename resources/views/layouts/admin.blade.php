...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item @if($page == 'berita') active @endif">
                <a class="nav-link" href=" {{ route('admin-berita') }} ">
                    <i class="far fas-fw fa-newspaper"></i>
                    <span>Berita</span></a>
            </li>
            <li class="nav-item nav-item @if($page == 'blog') active @endif">
                <a class="nav-link" href=" {{ route('admin-blog') }} ">
                    <i class="fas fas-fw fa-newspaper"></i>
                    <span>Blog</span></a>
            </li>
            ...
            <li class="nav-item @if($page == 'pengurus') active @endif">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="#">Informasi dan Komunikasi</a>
                        <a class="collapse-item" href="#">Dana dan Usaha</a>
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item @if($page == 'galeri') active @endif">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Developed By <a href="https://muhammadaskar.github.io" target="_blank">Muhammad Askar</a> 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
